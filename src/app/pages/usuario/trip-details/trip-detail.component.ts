...
export class TripDetailComponent implements OnInit {
  ...
  loadBusAndStations(): void {
    // Cargar información del bus desde el servidor
    ...
    // Cargar información de las estaciones de origen y destino desde el servidor
  ...
  // Método para confirmar la selección de asientos y redirigir a la página de boleta
  confirmSeatSelection(): void {
    ...
    // Marcar los asientos como no disponibles en sessionStorage
